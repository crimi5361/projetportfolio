...
const socialLinks = [
  ...
  },
  {
    ...
    subText: "crimi5361",
    icon: Github,
    url: "https://github.com/crimi5361?tab=overview&from=2024-11-01&to=2024-11-30",
    color: "#ffffff",
  ...
  },
  {
    ...
    icon: ({ className, ...props }: { className?: string } & React.SVGProps<SVGSVGElement>) => (
      <svg
        width="24px"
        height="24px"
        viewBox="0 0 45 45"
        ...
        className={className}
        {...props} // Keeps props available if needed
      >
        <title>Tiktok</title>
    ...
    url: "https://www.tiktok.com/@angeboga4?_t=ZM-8tS25Tb3tHq&_r=1 ",
    color: "black",
...
>
  ...
  <div 
    className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500
               bg-gradient-to-r ${linkedIn?.gradient || "from-gray-500 to-gray-700"}`} 
  />
  ...
  <div className="relative flex items-center gap-4">
    ...
    <div className="relative flex items-center justify-center">
      <div 
        ...
        style={{ backgroundColor: linkedIn?.color || "#888888" }} // Default fallback color
      />
      {linkedIn?.icon && (
  <div className="relative p-2 rounded-md">
    <linkedIn.icon
      className="w-6 h-6 transition-all duration-500 group-hover:scale-105"
      style={{ color: linkedIn?.color || "#888888" }} // Fallback color
    />
  </div>
)}
    </div>
